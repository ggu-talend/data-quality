...
public class DictionaryConstituents {
    ...
    public DictionaryConstituents(Map<String, DQCategory> metadata, UserDefinedClassifier regexClassifier, Index sharedDataDict,
            Index customDataDict, Index keyword) {
